...
csi_file_name = {
            'D:\simulation_ofdm\csi_seg\ls_csi_re5.txt';...
            'D:\simulation_ofdm\csi_seg\ls_csi_im5.txt';...
            }; 
esnr_file_name = {
...
save_file = {
             'D:\simulation_ofdm\out_put\correct_poss_ls5.txt';...
             'D:\simulation_ofdm\out_put\choose_seq_ls5.txt';
             };
csire = importdata(csi_file_name{1,1});
csiim = importdata(csi_file_name{2,1});
csi_data = csire + 1j.*csiim;
esnr_data_all = importdata(esnr_file_name{5,1});
